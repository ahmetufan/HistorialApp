...
class WarDetailsViewModel  (application: Application): BaseViewModel(application)  {

    val details=MutableLiveData<Savvas>()

    fun getDetailRoom3(id:Int){

        launch {

            val dao=UserDatabase(getApplication()).userDao().getSavasID(id)
